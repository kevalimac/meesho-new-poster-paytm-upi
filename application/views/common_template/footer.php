                ...
                <?php if (@$hide_footer == false) { ?>
                    ...
                    <div class="sc-bcXHqe fctQgp BottomNavBarstyled__StyledNavBar-sc-be71xz-0 iyYCAl BottomNavBarstyled__StyledNavBar-sc-be71xz-0 iyYCAl" color="white">

    <!-- Home Section -->
    <div class="sc-bcXHqe fctQgp BottomNavBarstyled__StyledNavItem-sc-be71xz-1 gREIBe BottomNavBarstyled__StyledNavItem-sc-be71xz-1 gREIBe" color="white" onclick="window.location.href='<?= base_url(); ?>'">
        <svg width="26" height="27" fill="none" xmlns="http://www.w3.org/2000/svg" iconsize="26" class="sc-gswNZR jGNacQ">
        ...
        <span font-size="11px" font-weight="book" color="greyT1" class="sc-ipEyDJ fAgIKg">Home</span>
    </div>

    <!-- Categories Section -->
    <div class="sc-bcXHqe fctQgp BottomNavBarstyled__StyledNavItem-sc-be71xz-1 gREIBe BottomNavBarstyled__StyledNavItem-sc-be71xz-1 gREIBe" color="white" onclick="window.location.href='<?= base_url(); ?>category'">
        <svg width="26" height="27" fill="none" xmlns="http://www.w3.org/2000/svg" iconsize="26" class="sc-gswNZR jGNacQ">
        ...
        <span font-size="11px" font-weight="book" color="greyT2" class="sc-ipEyDJ hhYIpu">Categories</span>
    </div>

    <!-- My Orders Section -->
    <div class="sc-bcXHqe fctQgp BottomNavBarstyled__StyledNavItem-sc-be71xz-1 gREIBe BottomNavBarstyled__StyledNavItem-sc-be71xz-1 gREIBe" color="white" onclick="window.location.href='<?= base_url(); ?>orders.php'">
        <svg width="26" height="27" fill="none" xmlns="http://www.w3.org/2000/svg" iconsize="26" class="sc-gswNZR jGNacQ">
            <path fill="#fff" d="M0 .657h26v26H0z"></path>
        ...
        <span font-size="11px" font-weight="book" color="greyT2" class="sc-ipEyDJ hhYIpu">My Orders</span>
    </div>
    ...
    <div class="sc-bcXHqe fctQgp BottomNavBarstyled__StyledNavItem-sc-be71xz-1 gREIBe BottomNavBarstyled__StyledNavItem-sc-be71xz-1 gREIBe" color="white" onclick="window.location.href='<?= base_url(); ?>'">
        ...
        <span font-size="11px" font-weight="book" color="greyT2" class="sc-ipEyDJ hhYIpu">Help</span>
    </div>
    ...
    <div class="sc-bcXHqe fctQgp BottomNavBarstyled__StyledNavItem-sc-be71xz-1 gREIBe BottomNavBarstyled__StyledNavItem-sc-be71xz-1 gREIBe" color="white" onclick="window.location.href='<?= base_url(); ?>'">
        ...
        <span font-size="11px" font-weight="book" color="greyT2" class="sc-ipEyDJ hhYIpu">Account</span>
    </div>
</div>
                <?php } ?>
